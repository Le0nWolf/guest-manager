  ...
  return `
    <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex items-center justify-between gap-4" data-guest-id="${guest.id}">
      ...
      <div class="flex items-center gap-2">
        ...
        ` : ''}
        <button class="delete-from-list-btn p-2 text-gray-500 hover:text-red-500 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors" data-id="${guest.id}" title="Loschen">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
