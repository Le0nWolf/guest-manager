...
describe('guestRepository', () => {
  ...
  describe('findAll', () => {
    ...
    it('should handle array format (legacy)', async () => {
      const mockGuests = [{ id: '1', name: 'Guest 1' }];
  ...
  describe('findById', () => {
    it('should return guest when found', async () => {
      ...
      expect(result).toEqual({ id: '2', name: 'Guest 2' });
    });
  ...
  describe('create', () => {
    it('should add guest to file', async () => {
      ...
      const newGuest = { id: '2', name: 'Guest 2' };
    ...
    it('should create file if it does not exist', async () => {
      const newGuest = { id: '1', name: 'Guest 1' };
  ...
  describe('update', () => {
    it('should update existing guest', async () => {
      ...
      const updatedGuest = { id: '1', name: 'Updated Guest' };
    ...
    it('should return null when guest not found', async () => {
      ...
      const result = await repository.update('999', { id: '999', name: 'Not Found' });
